...
data:extend({
  {
    ...
    collision_box = {{-0.02, -0.02}, {0.02, 0.02}},
      ...
      animation_list =
      {
        
        {
          ...
          animation =
          {
            ...
            {
              {
                filename = entity .. "hidden_beacon/factoriosmoke.png",
                width = 152, --180,
                height = 120, --202,
                scale = 1.52197,
                line_length = 5,
                frame_count = 180,
                animation_speed = 0.123,
            ...
            {
              {
                ...
                line_length = 5,
                frame_count = 180,
                animation_speed = 0.114,
                shift = util.by_pixel(0.3, -0.7),
                --draw_as_glow = true,
                --blend_mode = "additive",
                blend_mode = "additive",
              },
    ...
    open_sound = {filename = "__base__/sound/open-close/beacon-open.ogg", volume = 0.1},
    close_sound = {filename = "__base__/sound/open-close/beacon-close.ogg", volume = 0.1},
    working_sound =
    {
      sound =
      {
        filename = sounds .. "timewarp.ogg",
        volume = 0.2,
    ...
    --map_color = util.color("#00ffff22"),
    map_color = util.color("#7d19c055"),
  },
