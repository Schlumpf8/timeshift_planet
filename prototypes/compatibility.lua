...
if data.raw.recipe["thinking-brain"] then
  ...
  data.raw.recipe["thinking-brain"].sort_item_ingredients = false
end
...
if data.raw.recipe["cloning-vat"] then
  ...
  data.raw.recipe["cloning-vat"].sort_item_ingredients = false
  data.raw.recipe["cloning-vat"].categories = {"crafting-with-fluid"}
end
...
data.raw["item"]["datacell-ai-model-data"].subgroup = "moshine-datacells"
data.raw["item"]["datacell-ai-model-data"].order = "a[moshine]-cc"
...
data.raw["item"]["datacell-equation"].subgroup = "moshine-datacells"
data.raw["item"]["datacell-equation"].order = "a[moshine]-dd"
...
if mods["canal-excavator"] then
  data:extend({{
    ...
    data = {
      ...
      mineResult = {
        {type="item", name = "stone", independent_probability = 0.6, amount = 1},
        {type="item", name = "panglia_panglite", independent_probability = 0.2, amount = 1},
        {type="item", name = "iron-ore", independent_probability = 0.1, amount = 1},
        {type="item", name = "copper-ore", independent_probability = 0.1, amount = 1},
        {type="item", name = "uranium-238", independent_probability = 0.0005, amount = 1},
      }
    }
  }})
end